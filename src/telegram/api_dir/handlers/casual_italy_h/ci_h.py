...
from src.telegram.api_dir.handlers.casual_italy_h.ci_patterns import make_product
...
def reg_c(app):
    @app.on_message(chat('casual_italy_test') & media_group)
    ...
    @app.on_message(chat('casual_italy_test') & photo)
    ...
    @app.on_message(chat('casual_italy_test') & video)
